...
var ReactiveComponent = function (_Component) {
	...
	ReactiveComponent.prototype.componentWillMount = function componentWillMount() {
		...
		if (this.internalComponent && this.props.defaultQuery) {
			var _props$defaultQuery = this.props.defaultQuery(),
			    query = _props$defaultQuery.query,
			    queryOptions = _objectWithoutProperties(_props$defaultQuery, ['query']);
	...
	ReactiveComponent.prototype.render = function render() {
		...
		try {
			var childrenWithProps = _react2.default.Children.map(children, function (child) {
				return _react2.default.cloneElement(child, _extends({}, rest, { setQuery: _this2.setQuery }));
			});
