...
var DataController = function (_Component) {
	...
	function DataController() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.updateQuery = function () {
			...
			var query = props.customQuery ? props.customQuery : _this.defaultQuery;
			...
			(0, _helper.checkValueChange)(props.componentId, defaultSelected, props.beforeValueChange, props.onValueChange, performUpdate);
	...
	DataController.prototype.defaultQuery = function defaultQuery() {
		return {
			match_all: {}
		};
	};
