...
var _initialiseProps = function _initialiseProps() {
	...
	this.defaultQuery = function (value, props) {
		if (_this4.props.selectAllLabel && _this4.props.selectAllLabel === value) {
			return {
				exists: {
			...
			return _ref = {}, _ref[_this4.type] = (_this4$type = {}, _this4$type[props.dataField] = value, _this4$type), _ref;
		}
		return null;
	};
	...
	this.setValue = function (nextValue) {
		...
		(0, _helper.checkValueChange)(props.componentId, value, props.beforeValueChange, props.onValueChange, performUpdate);
	};
