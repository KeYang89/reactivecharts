...
var _initialiseProps = function _initialiseProps() {
	...
	this.defaultQuery = function (value, props) {
		...
		if (_this3.props.selectAllLabel && value.includes(_this3.props.selectAllLabel)) {
	...
	this.setValue = function (value) {
		...
		(0, _helper.checkValueChange)(props.componentId, finalValues, props.beforeValueChange, props.onValueChange, performUpdate);
	};
